...
`;
  ...
  videos.forEach(video => {
    ...
    if (video.status === "missing" || (video.songcount === undefined && (video.topic_id === "Birthday" || video.topic_id === "Anniversary" || video.topic_id === "3D_Stream")) || video.channel.name.toLowerCase().includes("holostar") || (video.channel.suborg && video.channel.suborg.toLowerCase().includes("holostar"))) {
      return;
    }
